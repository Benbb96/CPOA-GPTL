...
--
-- Client :  127.0.0.1
-- Généré le :  Mer 13 Janvier 2016 à 15:41
...
CREATE TABLE IF NOT EXISTS `arbitres` (
  ...
  `nbr_lits_reserv` varchar(3) NOT NULL,
  `hotel_reserv` varchar(70) NOT NULL,
...
INSERT INTO `arbitres` (`idArbitre`, `nomArbitre`, `prenomArbitre`, `attributArbitre`, `nbr_lits_reserv`, `hotel_reserv`) VALUES
(24, 'Belec', 'Hervé', 'Arbitre de Filet', '3', 'Hôtel Le Jardin Des Sens'),
(25, 'Leuseur', 'Abdul Augustin', 'Arbitre de Ligne', '3', 'Hotel des Arceaux');
...
(1, 'Clos de l''herminier', 'Chambre d''''hote', 2, '25 avenue du Moulin de Tourtourel', 34880, 'Lavérune', 29, 'OUI', 'OUI', 'NON', 'NON', 'NON', 'NON', 'NON', 'NON'),
(2, 'Hôtel Le Jardin Des Sens', 'hotel', 4, '11 Avenue Saint-Lazare', 34000, 'Montpelllier', 59, 'NON', 'OUI', 'OUI', 'OUI', 'OUI', 'OUI', 'OUI', 'NON'),
...
(3, 'Domaine De Verchant', 'Hotel', 5, '1 Bd Philippe Lamour', 34170, 'Castelnau-le-Lez', 138, 'OUI', 'OUI', 'OUI', 'OUI', 'OUI', 'OUI', 'OUI', 'OUI'),
(4, 'Hotel Courtyard', 'Hotel', 4, '105 Place Georges Freche (Rue du Chelia)', 34000, 'Montpellier', 62, 'OUI', 'OUI', 'OUI', 'OUI', 'OUI', 'OUI', 'NON', 'NON'),
(5, 'Hotel Balladins', 'Hotel', 3, 'Route de Carnon, Parc des Expos', 34470, 'Perols', 54, 'NON', 'OUI', 'OUI', 'NON', 'NON', 'OUI', 'OUI', 'OUI');
...
INSERT INTO `joueurs` (`idJoueur`, `nomJoueur`, `prenomJoueur`, `classementJoueur`, `nbr_lits_reserv`, `hotel_reserv`) VALUES
(24, 'Nadal', 'Raphael', 1, 2, 'Domaine De Verchant');
